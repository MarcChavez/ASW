...
def create
    ...
    respond_to do |format|
      if @tweet.save
        ...
        elsif @tweet.author.size < 4 && @tweet.content.size > 280
  ...
  #LIKE /tweets/1 or /tweets/1.json
  def like
   @tweet.likes += 1
    @tweet.save
    respond_to do |format|
